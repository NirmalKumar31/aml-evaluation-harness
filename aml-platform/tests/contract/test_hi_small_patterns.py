...
an earlier pattern parser, which counted BEGIN header lines as transactions:
...
PAT = ROOT / "data" / "bronze" / "patterns_Small"   # see the note below; this
# constant had the same pre-suffix defect the comment below diagnoses for REC
