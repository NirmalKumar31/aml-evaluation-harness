...
def main(argv=None) -> int:
    ...
    ap.add_argument("--thin-from", default=None,
                    help="the rung's transaction-volume collapse date (see "
                         ...
                         "comparable: pooled levels on this window are close "
                         "to the random-ranker null (1.16x-1.26x) and cannot "
                         "settle the encoding. No encoding effect has been "
                         "established; the day-blocked design has no "
                         "Holm-adjusted power to distinguish the arms.")
    ap.add_argument("--out",
