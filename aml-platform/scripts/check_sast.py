...
def scan(root: Path) -> dict[str, str]:
    ...
    COUNTS ARE NOT ENOUGH. With `B608: 50` in the baseline, fixing one
    f-string query and introducing another somewhere else leaves the total at
    50 and the gate green: a count proves only that the number did not move,
    not that no new finding arrived.
